    ...
    Object
        ...
        .forEach(joint => {
            ...
            li.update = () => {
                ...
                let jointNum = Number(joint.name.slice(-1));
                if (isNaN(jointNum)) jointNum = 7;

                fetch('http://localhost:8080/' + jointNum + '?angle=' + angle);
...
document.addEventListener('WebComponentsReady', () => {
    ...
    updateLoop();
    viewer.camera.position.set(0.4037191347202006, 0.7440264902471869, -0.34652772908960916);
