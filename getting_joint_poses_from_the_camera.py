    ...
    if ids is not None:
        try:
            ...
            if (flag):
                ...
                traj_for_AI = rtb.tools.trajectory.jtraj(robot.qr, robot.q, time_vec)
                # print(angle_joint) # Углы осей в целевой точке
                # print(traj_for_AI.q) # Углы осей при движении
